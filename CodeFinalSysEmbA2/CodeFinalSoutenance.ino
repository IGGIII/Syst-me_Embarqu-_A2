...
char paf="Temperature,Humidité,Pression,Luminosité,Resistance";
...
void setup(){
  ...
  if(!bme.begin(0x76)){ Serial.println("Erreur BME280"); while(1) delay(10);}
  if(!SD.begin(4)) Serial.println("Erreur SD"); // CS = 4
  if(!rtc.begin()){ Serial.println("RTC non détecté"); while(1) delay(10);}
